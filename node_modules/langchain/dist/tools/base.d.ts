import { z } from "zod";
import { BaseCallbackConfig, CallbackManagerForToolRun, Callbacks } from "../callbacks/manager.js";
...
export declare abstract class StructuredTool<T extends z.ZodObject<any, any, any, any> = z.ZodObject<any, any, any, any>> extends BaseLangChain {
    ...
    call(arg: (z.output<T> extends string ? string : never) | z.input<T>, configArg?: Callbacks | BaseCallbackConfig, 
    /** @deprecated */
