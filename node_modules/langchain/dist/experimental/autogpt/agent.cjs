...
class AutoGPT {
    ...
    async run(goals) {
        ...
        while (loopCount < this.maxIterations) {
            ...
            this.fullMessageHistory.push(new index_js_1.HumanMessage(user_input));
            this.fullMessageHistory.push(new index_js_1.AIMessage(assistantReply));
            ...
            this.fullMessageHistory.push(new index_js_1.SystemMessage(result));
        }
        return undefined;
    }
}
